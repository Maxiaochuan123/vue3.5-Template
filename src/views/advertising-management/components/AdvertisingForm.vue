...
<template>
  <NForm ref="formRef" :model="model" :rules="rules" label-placement="left" label-width="100">
    <NFormItem label="广告类型" path="type">
      <NSelect v-model:value="model.type" :options="typeOptions" placeholder="请选择广告类型" clearable />
    </NFormItem>
    ...
    <NFormItem label="广告标题" path="title">
      <NInput v-model:value="model.title" placeholder="视频广告主要内容，建议6-20个字符" :maxlength="20" show-count />
    </NFormItem>
    ...
    <NFormItem label="广告描述">
      <div class="space-y-2">
        ...
        <NButton v-if="model.description.length < 5" dashed class="w-full" @click="addDescription">添加描述</NButton>
      </div>
    </NFormItem>
  </NForm>
</template>
